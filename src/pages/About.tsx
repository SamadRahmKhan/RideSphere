    ...
    <Layout>
      <section className="py-16 bg-muted/30">
        <div className="container">
          <h1 className="font-display text-4xl md:text-5xl font-bold text-foreground mb-4">About TerraCycles</h1>
        ...
        <div className="container">
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
            <div>
              ...
              <p className="text-muted-foreground mb-4">TerraCycles was born from a simple belief: everyone deserves a bike that inspires them to ride more. Founded in Portland by a group of passionate cyclists, we set out to create bicycles that combine exceptional quality with sustainable practices.</p>
